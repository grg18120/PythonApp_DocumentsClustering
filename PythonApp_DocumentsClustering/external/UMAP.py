...
# Load high dimensional vectors(1797x64)
vectors, labels = load_digits(return_X_y=True)
print(f'vectors: Type = {type(vectors)} Shape = {vectors.shape}')
print(f'labels: Type = {type(labels)} Shape = {labels.shape}')



# UMAP embeddings(1797x2)
